...
export const SEARCH_PATIENT_CLICK = 'SEARCH_PATIENT_CLICK';
export const SEARCH_PATIENT_SUCCESS = 'SEARCH_PATIENT_SUCCESS';
export const SEARCH_PATIENT_FAIL = 'SEARCH_PATIENT_FAIL';
export const SEARCH_VALIDATION_ERROR = 'SEARCH_VALIDATION_ERROR';
export const ENTER_NEW_PATIENT = 'ENTER_NEW_PATIENT';
